...
if(isset($_POST['validate'])  ) {
    ...
    if(isset($_SESSION['auth']))  { 
        if(!empty($_POST['answer'])) {
            ...
            $insertAnswer->execute(array($_SESSION['id'], $_SESSION['pseudo'], $idOfTheQuestion, $user_answer)); //'$_SESSION['id']'=> variable globale déclarée dans connexion
        }
    }else{
        $errorMsg = "Vous n'êtes pas connecté !";
    }
}